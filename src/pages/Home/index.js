...
function Home() {
    return (
        <div className={cx("wrapper")}>
            <div className={cx("home01")}>
                {/* <div className={cx("backgroundhome1")}></div> */}
                <div className={cx("section-001")}>
                    ...
                    <div className={cx("box-01")}>
                        ...
                        <div className={cx("box-body")}>
                            ...
                            <p className={cx("box-description")}>
                                Non parturient amet, feugiat <br /> tellus
                                sagittis, scelerisque <br /> eget nulla turpis.
                            </p>
                        </div>
                    </div>
                ...
                <div className={cx("aboutus")}>
                    <div className={cx("left-aboutus")}>
                        ...
                        <p className={cx("description-aboutus")}>
                            ...
                            elit. Elit,
                            <br /> quam suscipit purus donec amet. Egestas
                            volutpat facilisi eu
                            <br /> libero. Nunc, ipsum ornare mauris sit quam
                            quis enim. Varius
