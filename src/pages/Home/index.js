        ...
        <div className={cx("wrapper")}>
            ...
            <div className={cx("Main-Services")}>
                <div className={cx("main-text")}>
                    ...
                    <p className={cx("description-main-1")}>
                        ...
                        <br /> feugiat tellus sagittis, scelerisque eget nulla
                        turpis.
                    </p>
                </div>
            </div>
                ...
                <div className={cx("box-01")}>
                    ...
                    <div className={cx("box-body")}>
                        ...
                        <p className={cx("box-description")}>
                            Non parturient amet, feugiat <br /> tellus sagittis,
                            scelerisque <br /> eget nulla turpis.
                        </p>
                    </div>
                </div>
            ...
            <div className={cx("aboutus")}>
                <div className={cx("left-aboutus")}>
                    ...
                    <h1 className={cx("title-aboutus")}>
                        We are the best beauty clinic
                    </h1>
                    <p className={cx("description-aboutus")}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Elit,
                        <br /> quam suscipit purus donec amet. Egestas volutpat
                        facilisi eu
                        <br /> libero. Nunc, ipsum ornare mauris sit quam quis
                        enim. Varius
                        <br /> tellus in suspendisse placerat.
                        <br />
                        <br />
                        Id dui erat sed quam tellus in purus. Pellentesque
                        congue <br /> fringilla cras tellus enim.
                    </p>
                    <div className={cx("btn-aboutus")}>
                        <Link className={cx("link")} to="" href="./Service">
            ...
            <div className={cx("section-form")}>
                ...
                <div className={cx("input-form")}>
                    ...
                    <div className={cx("btn-form")}>
                        <button className={cx("btnform")}>Send Message</button>
                    </div>
                </div>
            </div>
        </div>
